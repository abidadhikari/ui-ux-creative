...
export default function NavBar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 pt-10  w-full flex   justify-center items-center ">
      <nav className=" flex flex-wrap items-center justify-center gap-0  text-sm md:text-lg text-black bg-white backdrop-blur-2xl w-fit max-w-[90%] px-[10px] md:px-[45px] py-4 rounded-[100px] shadow-2xl">
        <Link href="#work" className="py-[10px] px-[16px] ">
          Work
        </Link>

        <Link href="#process" className="py-[10px] px-[16px] ">
          Process
        </Link>
        <Link
